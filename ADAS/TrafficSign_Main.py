...
model.export('my_neural_network_model')
model.save('my_neural_network_model.h5')

# Convert the model to TensorFlow Lite format
converter = tf.lite.TFLiteConverter.from_saved_model('my_neural_network_model')
tflite_model = converter.convert()

# Save the converted model
with open('my_neural_network_model.tflite', 'wb') as f:
